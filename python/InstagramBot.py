...
class InstagramBot:
    def __init__(self, username, password):
        ...
        self.options.add_argument("--lang={}".format('en'))
        self.browser = webdriver.Chrome(executable_path = 'D:\Projeler\Instagram Çekiliş Botu\chromedriver.exe', chrome_options= self.options)
